...
Let’s assume that we have a small fraction (Df) of the dataset already labeled. Following are the steps for training models using active learning :
 ...
 - Repeat until a  <a href="https://machinelearningmastery.com/how-to-know-if-your-machine-learning-model-has-good-performance/" target="_blank" rel="noopener noreferrer" style="color:blue">good enough model</a> is trained.
