...
One of the best papers I came across in 2020 was the Google Brain team’s ***Self-training with Noisy Student***. It is a semi-supervised technique that works well even when we have a sufficient amount of labeled data. So much that it beat the then SOTA by a whole 2% gain on ImageNet-A top 1% accuracy. This technique also increases the robustness of a model. 
...
<img src="{{ site.url }}/img/projects/noisy_student/algo.png" width="50%" hight="50%"> 
...
<img src="{{ site.url }}/img/projects/noisy_student/comparison.png" width="50%" hight="50%"> 
...
<img src="{{ site.url }}/img/projects/noisy_student/result_0.png" width="50%" hight="50%"> 
<img src="{{ site.url }}/img/projects/noisy_student/result_1.png" width="50%" hight="50%"> 
